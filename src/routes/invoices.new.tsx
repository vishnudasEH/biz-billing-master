...
export const Route=createFileRoute('/invoices/new')({validateSearch:(s:Record<string,unknown>)=>({jobId:typeof s["jobId"]==='string'?s["jobId"] as string:undefined}),head:()=>pageMeta('New invoice','Prepare a GST tax invoice for your customer.'),component:NewInvoice});
